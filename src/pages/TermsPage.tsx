      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="space-y-8 text-base text-foreground leading-relaxed">
          <section>
            ...
            <p>
              Daily Guardian is a daily check-in service that sends automated SMS messages
              to users at a scheduled time. If a user does not respond within a configurable
              grace period, their designated emergency contacts are notified via SMS in
              priority order.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Keep your account information and emergency contacts up to date.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              your name, phone number, check-in schedule, and emergency contact
              information. We do not sell your data to third parties. SMS messages are
              sent through third-party providers (Twilio) subject to their own privacy
              policies.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-black mb-3">7. Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black mb-3">8. Changes to These Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black mb-3">9. Contact</h2>
            <p>
